...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/79mj58zs/settings/api) and create a token with read rights.
